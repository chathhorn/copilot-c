...
module Copilot.Compile.C.ACSLProof
  ( transformProofACSL
  )
where
...
transformExpr' = \ case
  ...
  Op1 op e                        -> transformOp1 (transformExpr' e) op
  Op2 op e1 e2                    -> transformOp2 (transformExpr' e1) (transformExpr' e2) op
  Op3 op e1 e2 e3                 -> transformOp3 (transformExpr' e1) (transformExpr' e2) (transformExpr' e3) op
...
transformOp1 :: Expr a -> Op1 a b -> Expr b
transformOp1 e = \ case
    -- Boolean operators.
  Not          -> Op1 Not e
  -- Numeric operators.
...
transformOp2 :: Expr a -> Expr b -> Op2 a b c -> Expr c
transformOp2 e1 e2 = \ case
  -- Floating operators.
...
transformOp3 :: Expr a -> Expr b -> Expr c -> Op3 a b c d -> Expr d
transformOp3 e1 e2 e3 = \ case
